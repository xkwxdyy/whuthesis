...
根据 \cls{whu-thesis} 的 GitHub （当然还有一些其它学校的 \LaTeX 模板 GitHub）上的\href{https://github.com/whutug/whu-thesis/issues}{问题}和\href{https://github.com/whutug/whu-thesis/discussions}{讨论}，以及自己一些毕业论文模板开发经验，可以看到一些不仅是 \cls{whu-thesis}，甚至是大部分毕业论文 \LaTeX{} 模板都存在的问题。
