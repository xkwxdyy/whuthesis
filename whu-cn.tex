...
和 \CTeX 宏集一样，\WhuTeX 也提供了提供了 \opt{numberformat}，\opt{nameformat}，\opt{titleformat}，\opt{format} 这几个选项用来控制章节标题的格式。它们的作用范围如\cref{fig:heading-format} 所示。
...
{\centering \fbox{\parbox{.93\textwidth}{\cs{whu@type@contentsline}
  ...
  \null\quad\marg{list entry}\marg{thepage}\marg{anchor}\cs{whu@type@contentsline@}}}\par}
