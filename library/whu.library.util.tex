...
\cs_new:Npn \__whu_new_cs_empty:N #1
  {
    \cs_new:Nn #1 { }
  }
...
\cs_new:Npn \__whu_month_convert_to_english:n #1
  {
    \prop_get:NnN \l__whu_month_prop {#1} \l__whu_tmpa_tl
    \l__whu_tmpa_tl
  }
\cs_generate_variant:Nn \__whu_month_convert_to_english:n { x }

\cs_new:Npn \__whu_date_convert_to_chinese:nn #1#2
  {
    \zhdigits { #1 }
    % \, 
    年
