...
\cs_new:Nn \__whu_cover_zh: 
  {
    \begin{tikzpicture}[remember~picture, overlay]
      ...
      \__whu_cover_zh_date:
      \__whu_cover_zh_information:  % 因为 information 是用了 tikz 的 above of date，所以 date 要在前面
    \end{tikzpicture}
  }
\cs_new:Nn \__whu_cover_en: 
  {
    \begin{tikzpicture}[remember~picture, overlay]
      ...
      \__whu_cover_en_information:  % 因为 information 是用了 tikz 的 above of universitylogo，所以 universitylogo 要在前面
...
\keys_define:nn { whu/cover/zh/width }
  {
    head-underline .dim_gset:N = \g__whu_cover_zh_head_underline_width_dim,
...
\cs_new:Nn \__whu_cover_zh_head_underline:
  {
    ...
    \raisebox { -0.3ex } { \underline { \hspace*{ \g__whu_cover_zh_head_underline_width_dim } } }
  }
    ...
    \raisebox { -0.3ex } 
      {
        \underline 
          {
            \raisebox { 0.3ex } { \makebox[ \g__whu_cover_zh_head_underline_width_dim ] { \hfil #1 \hfil } } 
          } 
      }
  }
...
\cs_new:Nn \__whu_cover_en_information_content: 
  {
    % 调用其中一种时，其余为空
    \__whu_cover_en_proposal_information_content:
    \__whu_cover_en_bachelor_information_content:
    \__whu_cover_en_master_information_content:
    \__whu_cover_en_doctor_information_content:
  }
\cs_new:Nn \__whu_cover_en_proposal_information_content: { }
\cs_new:Nn \__whu_cover_en_bachelor_information_content: { }
\cs_new:Nn \__whu_cover_en_master_information_content: { }
\cs_new:Nn \__whu_cover_en_doctor_information_content: { }
